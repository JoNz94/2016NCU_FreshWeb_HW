		...
		public function doLogin($user = null) {
			try {
				...
				if (! $openid->mode) {
					...
					$openid->required = array(	'user/roles' );
						
					$openid->optional = array(	'contact/email',	'contact/name','contact/ename',	'student/id',	'alunmi/leaveSem'	);
					...
					#echo '<script language="javascript">location.href="'. $openid->authURL() .'";</script>';
					#return;
