  ...
  if(isset($_POST["username"]) && isset($_POST["password"])){   
    ...
    if(md5($_POST["password"])==$row_RecLogin["password"]){
      ...
      <script type="text/javascript">
        window.alert("登入成功!");
        window.location.assign("todolist3.php");
      </script>
  <?php
    }else{?>
    <script type="text/javascript">
...
<body class="custom-homepage">
    ...
    <div class=container>
      ...
      <div id=navbar class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active"><a href="./" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">To Do List<span class="caret"></span></a>
            <ul class="dropdown-menu dropdown-inverse" role="menu">
              <li><a href="todolist.php">ver. ul</a></li>
              <li><a href="todolist2.php">ver. table</a></li>
              <li class="active"><a href="#">ver. div</a></li>
            </ul>
          </li>
  ...
  <div class=jumbotron>
    <div class=container>
      <h1>To Do List <small>(ver. div)</small></h1>
      <p>備忘錄です。</p><br>
    </div>
  </div>
  <div class=container>
    <div class=row>
      ...
      <div class=col-md-4>
        <div class="panel panel-default" align="center" style="padding: 50px 60px 30px;">
          <div class="row">
            <div class="input-group">
              <input type="text" class="form-control" id="userInput" placeholder="要做的事...">
  ...
  <script src=/js/to-do-list3.js></script>
</body>
