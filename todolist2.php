  ...
  if(isset($_POST["username"]) && isset($_POST["password"])){   
    ...
    if(md5($_POST["password"])==$row_RecLogin["password"]){
      ...
      <script type="text/javascript">
        window.alert("登入成功!");
        window.location.assign("todolist2.php");
      </script>
  <?php
    }else{?>
    <script type="text/javascript">
...
<body class="custom-homepage">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active"><a href="./" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">To Do List<span class="caret"></span></a>
            <ul class="dropdown-menu dropdown-inverse" role="menu">
              ...
              <li class="active"><a href="#">ver. table</a></li>
  ...
  <div class=jumbotron>
    <div class=container>
      <h1>To Do List <small>(ver. table)</small></h1>
      <p>備忘錄です。</p><br>
    </div>
  </div>
  <div class=container>
  ...
  <script src=/js/to-do-list2.js></script>
</body>
